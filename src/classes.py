class Align:
    ...
    def __init__(self, read_name, chr, ref_start, ref_end, read_start, read_end, length, direct, seq, align_type, isize=-1):
...
class Junction:
    ...
    def __init__(self, junc_type, junc_sub_type, support_reads, include_bkps):
    ...
    def merge(self, target_junc):
        ...
        self.support_reads.extend(target_junc.support_reads)
...
class Junction_Series:
    ...
    def to_string(self):
        ...
        for i in range(self.get_junc_num()-1):
            ...
            string += "-{}:{}".format(self.include_juncs[i+1].include_bkps[0].chrom,self.include_juncs[i+1].include_bkps[0].pos)
    ...
    def get_include_juncs_minus(self):
        ...
        return Junction_Series(include_juncs_minus, self.support_reads, end_minus)
    ...
    def merge(self, target_juncSe, overlap_start_on_self, overlap_start_on_target, overlap_num):
        ...
        self.support_reads.extend(target_juncSe.support_reads)
    ...
    def combine(self, next_juncSe):
        ...
        for read in next_juncSe.support_reads:
            self.support_reads.append(read)
...
class Single_same_Multi_junc:
    def __init__(self, same_bkp_info, juncSe1_info, juncSe2_info, support_junc_series, support_reads, seqs):
        self.same_bkp_info = same_bkp_info
        self.juncSe1_info = juncSe1_info
        self.juncSe2_info = juncSe2_info
        self.support_junc_series = support_junc_series
        self.support_reads = support_reads
        self.seqs = seqs
    
    def to_string(self):
        string = "{}-[{}/{}]".format(self.same_bkp_info.to_string(), self.juncSe1_info.to_string(), self.juncSe2_info.to_string())
        string += '\n'
